...
public class invalidpostmisspass {
  ...
  public void f() throws BiffException, IOException {
	  ...
	  excel a=new excel();
	    ...
	    String endpoint = a.readexcel(9,31);
	    System.out.println(endpoint);
	    String email = a.readexcel(6,31);
      ...
      String jsonstring = "{\n"
        ...
        {
            a.writexcel("testcases",12, 28, "passed");
        }
        else
        {
            a.writexcel("testcases",12, 28, "failed");
        }
  }
}
