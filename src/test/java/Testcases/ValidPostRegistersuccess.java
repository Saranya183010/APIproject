...
public class ValidPostRegistersuccess {
  ...
  public void f() throws BiffException, IOException {
	  ...
	  excel a=new excel();
	    ...
	    String email = a.readexcel(4,17);
	    System.out.println(email);
	    String password = a.readexcel(5,17);
...
//	  System.out.println();
      ...
      {
          a.writexcel("testcases",12, 17, "passed");
      }
      else
      {
          a.writexcel("testcases",12, 17, "failed");
      }
  }
}
