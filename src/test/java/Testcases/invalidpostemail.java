...
public class invalidpostemail {
  ...
  public void f() throws BiffException, IOException {
	  ...
	  excel a=new excel();
	    ...
	    String endpoint = a.readexcel(9,28);
	    System.out.println(endpoint);
	    String password = a.readexcel(6,28);
      ...
      String jsonstring = "{\n"
        ...
        {
            a.writexcel("testcases",12, 24, "passed");
        }
        else
        {
            a.writexcel("testcases",12, 24, "failed");
        }
  }
}
